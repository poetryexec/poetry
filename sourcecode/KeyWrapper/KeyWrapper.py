...
class KeyWrapper(object):
    ...
    def __loadDic(self):
        # Load TF-IDF 
        self.__tfidf = {}       
        fin = open(self.__root_dir + "data/tfidf.txt",'r',encoding='utf-8')
        line = fin.readline()
        while line:
        ...
        # Load word frequency
        self.__freq = {}
        fin = open(self.__root_dir + "data/wordsfreq.txt",'r',encoding='utf-8')
        line = fin.readline()
        while line:
            para = line.strip().split(" ")
        ...
        # Load function words
        self.__func = {}
        fin = open(self.__root_dir + "data/FunctionWords.txt",'r', encoding='utf-8')
        lines1 = fin.readlines()
        fin.close()

        fin = open(self.__root_dir + "data/fchar.txt",'r', encoding='utf-8')
